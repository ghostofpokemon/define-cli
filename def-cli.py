...
class Synonym:
    ...
    def req(self):
        ...
        try:
            ...
            dic = {}
            for i in tabs:
                synlis = [(i["term"], i["similarity"]) for i in 
i["synonyms"]]
                antlis = [(i["term"], i["similarity"]) for i in 
i["antonyms"]]
                dic[i["definition"]] = {
                    "pos": i["pos"],
                    "synonyms": synlis,
            ...
            didym = soup.find("span", attrs={"class": "css-1umtscx 
e1rvdh510"})
